      ...
      <section className="py-28">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between mt-8 gap-10">
          ...
          >
            ...
            >
              <Link
                href="mailto:rishabh212malviya@gmail.com"
                className="mt-6 flex gap-5 items-center hover:scale-105 transition-transform duration-300"
              >
                <div
                  className={`p-3 border-2 rounded-full font-bold ${
                    darkMode
