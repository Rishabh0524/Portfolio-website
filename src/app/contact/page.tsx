...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with Rishabh Malviya for MERN stack projects, Next.js applications, collaborations, and job opportunities.",
  keywords: [
    "Contact Rishabh Malviya",
    "Hire MERN Stack Developer",
    "Next.js Developer Contact",
    "TypeScript Developer",
    "Web Developer Consultation",
    "Freelance MERN Developer",
    "Work with Rishabh Malviya",
